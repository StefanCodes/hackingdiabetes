smohr NOTE: This is a pull from the dexcom_reader project on GitHub. Changes are being hacked into the existing code, eschewing all good programming practices.
